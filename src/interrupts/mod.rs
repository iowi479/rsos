...
lazy_static! {
    static ref IDT: InterruptDescriptorTable = {
        ...
        idt[Into::<u8>::into(InterruptIndex::Timer)].set_handler_fn(timer_interrupt_handler);
        idt[Into::<u8>::into(InterruptIndex::Keyboard)].set_handler_fn(keyboard_interrupt_handler);
